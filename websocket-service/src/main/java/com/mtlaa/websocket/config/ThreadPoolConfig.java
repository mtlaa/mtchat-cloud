...
import com.mtlaa.websocket.config.properties.CommonThreadPoolProperties;
import com.mtlaa.websocket.config.properties.PushThreadPoolProperties;
...
public class ThreadPoolConfig implements AsyncConfigurer, SecureInvokeConfigurer {
    private static Executor websocketServiceExecutor;

    public static final String MTCHAT_EXECUTOR = "mtchatExecutor";
    public static final String WEBSOCKET_PUSH_EXECUTOR = "pushExecutor";
    ...
    public Executor getAsyncExecutor() {
        return websocketServiceExecutor;
    }
    ...
    public ThreadPoolTaskExecutor mtchatExecutor(CommonThreadPoolProperties properties){
        ...
        websocketServiceExecutor = executor;
        return executor;
    }
    /**
     * websocket 推送线程池
